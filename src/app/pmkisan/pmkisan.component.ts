...
@Component({
  selector: 'app-pmkisan',
  templateUrl: './pmkisan.component.html',
  styleUrls: ['./pmkisan.component.css']
})
export class PmkisanComponent implements OnInit {
  ...
  ngOnInit() {
  	...
  	const data = [
  	{"customerName":"Vanlalsailova Ralte", "aadhaarno": "123654789025", "accountNo": "97004545874"},
  	{"customerName":"Zopuii Ngente", "aadhaarno": "987456321456", "accountNo": "250445654789"}
